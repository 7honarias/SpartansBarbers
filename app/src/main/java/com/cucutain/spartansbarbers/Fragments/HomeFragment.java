...
import com.cucutain.spartansbarbers.Adapter.HomeSliderAdapter;
import com.cucutain.spartansbarbers.Adapter.LookbookAdapter;
import com.cucutain.spartansbarbers.BookingActivity;
import com.cucutain.spartansbarbers.CartActivity;
...
import com.cucutain.spartansbarbers.Interface.IBannerLoadListener;
import com.cucutain.spartansbarbers.Interface.IBookingInfoLoadListener;
import com.cucutain.spartansbarbers.Interface.IBookingInformationChangeListener;
import com.cucutain.spartansbarbers.Interface.ICountItemInCartListener;
import com.cucutain.spartansbarbers.Interface.ILookbookLoadListener;
...
import com.cucutain.spartansbarbers.Service.PicassoImageLoadingService;
...
public class HomeFragment extends Fragment implements ILookbookLoadListener, IBookingInfoLoadListener, IBookingInformationChangeListener, ICountItemInCartListener {
    ...
    private void changeBookingFromUser() {
        androidx.appcompat.app.AlertDialog.Builder confirmDialog = new androidx.appcompat.app.AlertDialog.Builder(getActivity())
                .setCancelable(false)
                .setTitle("Hey")
                .setMessage("Realmente deseas cambiar tu cita?\n solo confirma")
    ...
    private void deleteBookingFromUser(boolean isChange) {
        if (!TextUtils.isEmpty(Common.currentBookingId))
        {
            ...
            userBookingInfo.delete().addOnFailureListener(new OnFailureListener() {
                ...
                public void onSuccess(Void aVoid) {
                    ...
                    Toast.makeText(getActivity(), "Cita cancelada exitosamente!!", Toast.LENGTH_SHORT).show();
        ...
        {
            dialog.dismiss();
            Toast.makeText(getContext(), "Booking information must not be delete", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    @OnClick(R.id.card_view_shoping)
    ...
    private void loadUserBooking() {
        ...
        //aqui modifique getTimeInMillis por getTime
