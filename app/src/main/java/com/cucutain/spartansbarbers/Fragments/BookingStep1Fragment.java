...
import com.cucutain.spartansbarbers.Adapter.MySalonAdapter;
import com.cucutain.spartansbarbers.Common.Common;
import com.cucutain.spartansbarbers.Common.SpacesItemDecoration;
import com.cucutain.spartansbarbers.Interface.IAllSalonLoadListener;
import com.cucutain.spartansbarbers.Interface.IBranchLoadListener;
...
public class BookingStep1Fragment extends Fragment implements IAllSalonLoadListener, IBranchLoadListener {
    ...
    private void initView() {
        ...
        recycler_salon.setLayoutManager(new GridLayoutManager(getActivity(),1));
